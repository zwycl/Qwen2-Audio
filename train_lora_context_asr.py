...
class ContextASRLoRADataset(Dataset):
    """
    ContextASR-Bench dataset for LoRA fine-tuning.
    ...
    def __init__(
        ...
        for entry in metadata:
            ...
            # The audio path in metadata might be relative to data_dir or config/language
            possible_paths = [
        ...
        logger.info(
            ...
            f"{skipped['no_entities']} no_entities)"
        )
